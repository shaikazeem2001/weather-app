...
function weatherDetails(info) {
  if (info.cod == "404") {
    ...
    if (id == 800) {
      ...
      alert('stormy weather dont go outside');
      wIcon.src = "icons/storm.svg";
    } else if (id >= 600 && id <= 622) {
      
      wIcon.src = "icons/snow.svg";
      alert('snowy weather,santa is on the way');
    } else if (id >= 701 && id <= 781) {
      
      wIcon.src = "icons/haze.svg";
      alert('hazy weather,wanna have chai!!');
    } else if (id >= 801 && id <= 804) {
      
      wIcon.src = "icons/cloud.svg";
      alert('cloudy weather,cancel your plans');
    } else if ((id >= 500 && id <= 531) || (id >= 300 && id <= 321)) {
      
      wIcon.src = "icons/rain.svg";
      alert('dont go outsideits raining outside,dont forget umbrella');
    }
